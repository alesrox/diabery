...
<head>
    ...
    <style>
        ...
        /* Ajustes para que nada se salga en pantallas mini */
    ...
    <div class="p-3 p-md-4">
        ...
        @forelse($entries as $entry)
            @php
                ...
                if ($isLate) {
                    ...
                    $iconColor = 'text-white'; // Icono blanco sobre fondo amarillo queda mejor
                    ...
                    <div class="card-body d-flex align-items-center p-3">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            <div class="d-flex align-items-baseline">
                                <span class="fw-bold text-capitalize text-truncate me-1">{{ $entry->meal_type }}</span>
                        ...
                        <div class="ms-3 d-flex align-items-center border-start ps-3">
                            <div class="glucose-box me-3">
                                <div class="fw-bold fs-5 text-dark">{{ $entry->glucose_pre }}</div>
                            ...
                            <div class="glucose-box">
                                ...
                                @elseif($isLate)
                                    <span class="badge bg-warning text-dark py-1 px-2" style="font-size: 0.65rem;">¡MEDIR YA!</span>
                                @else
                                    <span class="badge rounded-pill bg-white text-primary border border-primary-subtle py-1 px-2" style="font-size: 0.6rem;">MEDIR</span>
                                @endif
                            </div>
                        </div>
        ...
        @empty
            <div class="text-center py-5">
                <p class="text-muted small">No hay registros hoy</p>
            </div>
        @endforelse
    </div>
</div>
